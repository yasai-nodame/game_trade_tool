...
checkbox.click()
sleep(20)
captcha_get = driver.find_element(By.TAG_NAME,'div')
a_1 = captcha_get.find_element(By.CLASS_NAME,'rc-image-tile-target')
a_2 = a_1.find_element(By.TAG_NAME,'div')
a_3 = a_2.find_element(By.CLASS_NAME,'rc-image-tile-wrapper')
a_4 = a_3.find_element(By.TAG_NAME,'img')
a_5 = a_4.find_element(By.CLASS_NAME,'rc-image-tile-33')['src']
