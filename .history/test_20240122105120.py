...
checkbox.click()
sleep(20)
captcha_get = driver.find_element(By.CLASS_NAME,'rc-image-tile-44')
print(captcha_get)
driver.quit()

# requestsを使用してプロキシを指定したHTTPリクエストを行う
payload = {'api_key': '3309439563baad6898dfd8dde3732678', 'url': 'https://gameclub.jp/signin', 'country_code': 'us', 'device_type': 'desktop'}
response = requests.get('https://api.scraperapi.com/', params=payload, proxies={"http": proxy[0], "https": proxy[1]})
