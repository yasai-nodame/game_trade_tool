...
def execution(): 
    ...
    urls = ['https://gameclub.jp/signin','https://gameclub.jp/mypage','https://gameclub.jp/mypage/products/add','https://gameclub.jp/mypage']
    ...
    mypage_menu_get = driver.find_elements(By.CLASS_NAME,'side-mypage-menu')[4]
    print(mypage_menu_get)
