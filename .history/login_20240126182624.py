    ...
    if count > 0:
        ...
        if items:
            ...
            if comment_check.text == '0': #ここから　　出品終了のタグを見つけて自動削除させる
                ...
                selling_exit_a = selling_exit.find_element(By.TAG_NAME,'a')
                l = selling_exit_a.find_element(By.CLASS_NAME,'btn btn-danger jsProductClose loader-on-submit')
                # l = selling_exit_a.get_attribute('href')
                print(selling_exit_a.text)
                print(l)
    sleep(5)
