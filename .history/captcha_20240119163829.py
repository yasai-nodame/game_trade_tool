...
proxy = {
    "http":"http://186.125.218.170:999",
    "https":"http://186.125.218.170:999"
}

headers = {
    "User-Agent":"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Trident/7.0; .NET4.0C; .NET4.0E; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR 3.5.30729)"
}

def get_captcha_image_url():
    url = 'https://gameclub.jp/signin'
    response = requests.get(url,proxies=proxy,headers=headers,timeout=100)
