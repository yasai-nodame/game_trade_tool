...
game_title_id = driver.find_element(By.ID,'btn-search-title btn-modal')
game_title_id.click()

game_title_span = driver.find_element(By.CSS_SELECTOR,'span.title-name')
# game_title_write_text = driver.find_element(By.ID,'btn-search-title btn-modal')
# game_title_write_text.send_keys('アークナイツ') #タイトルテキストに記入

radio_class = driver.find_element(By.CLASS_NAME,'input radio')
radio_class_choice = radio_class.find_element(By.ID,'account-type-id-10')
radio_class_choice.click() #ラジオボタンクリック